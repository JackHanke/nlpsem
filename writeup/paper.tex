...
Despite the BPE algorithm building a vocabulary by directly referencing the frequency of subwords, these vocabularies are still Zipfian, and follow the word frequency distribution up to the rarest few tokens. Moreover, the tokenizers this algorithm produces creates Zipfian distributed tokens outside of the corpus it is trained on. When considering all possible tokens, the most common tokens tend to be punctuation, newline characters, and control tokens. Excluding punctuation and special tokens, we recover the known most common English words. 

\section{Conclusions \& Future Work}

Noticeable theoretical work has been done in service of explaining Zipf's law for language \cite{li1992} 

\textit{On the statistical laws of linguistic distributions}\cite{Belevitch1959}
